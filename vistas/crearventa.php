  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
      ...
      <div class="input-group">
            ...
            <button class="btn btn-success" type="button" onclick="agregarCliente()"><i class="fa fa-plus-circle"></i>Agregar</button>
            </span>
      </div>
    </div>
...
<div class="form-group  col-lg-12 col-md-12 col-xs-12">
     <table id="detalles" class="table table-striped table-bordered table-condensed table-hover text-center">
      <thead class="bg-aqua">
        ...
        <div style="background-color:#A9D0F5; height: 31px; border: #ffff 1px solid;"><label> SubTotal</label><span id="total" class="pull-right badge bg-blue"><label><?php echo $smoneda; ?> 0.00</span></div>
        <div style="background-color:#A9D0F5; height: 31px; border: #ffff 1px solid;"><label id="valor_impuesto"><?php echo $tipo_impuesto; ?> 0.00</label><span id="most_imp" class="pull-right badge bg-aqua">0.00</span></div>
        <div style="background-color:#A9D0F5; height: 31px; border: #ffff 1px solid;"><label> TOTAL</label> <span id="most_total" class="pull-right badge bg-green">0.00</span></div>
        <div style="background-color:#F5B041; height: 31px; border: #ffff 1px solid;"><label> Cant. pagado</label><input type="hidden" step="0.01" name="total_venta" id="total_venta">
            <input class="pull-right" onchange="modificarSubtotales()" style="width: 100px; height: 31px;" type="number" step="0.01" name="tpagado" id="tpagado"></div>
        <div style="background-color:#F5B041; height: 31px; border: #ffff 1px solid;"><label> Cambio</label> <span id="vuelto" class="pull-right badge bg-red">0.00</span></div>
    ...
    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <a href="venta.php"><button class="btn btn-danger"  type="button" id="btnCancelar"><i class="fa fa-arrow-circle-left"></i> Cancelar</button></a>
    </div>
  </form>
</div>
<!--fin centro-->
          ...
          <div class="col-md-6">
            <div class="box box-warning">
              <div class="panel-body" id="formularioregistros">
                <div class="box-header with-border">
                  <h1 class="box-title">Agrega un articulo</h1>
                  <div class="box-tools pull-right">
