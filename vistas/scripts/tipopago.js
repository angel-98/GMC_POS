...
function mostrar(id_tipopago){
	$.post("../ajax/tipopago.php?op=mostrar",{id_tipopago : id_tipopago},
...
function desactivar(id_tipopago){
	bootbox.confirm("¿Esta seguro de desactivar este dato?", function(result){
		if (result) {
			$.post("../ajax/tipopago.php?op=desactivar", {id_tipopago : id_tipopago}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
...
function activar(id_tipopago){
	bootbox.confirm("¿Esta seguro de activar este dato?" , function(result){
		if (result) {
			$.post("../ajax/tipopago.php?op=activar" , {id_tipopago : id_tipopago}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
