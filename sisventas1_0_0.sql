...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2020 a las 06:21:19
...
(2, 'Grupo Concepto SpA', 'RUT', 2332112, 'Monjitas 550 - Of.19', 993321337, 'victor@conceptoweb.cl', '1585963556.png', 'Chile', 'Santiago', 'IVA', 19.00, 'PESOS', '$', 0);
...
--
ALTER TABLE `comp_pago`
  MODIFY `id_comp_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `detalle_venta`
  MODIFY `iddetalle_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
--
ALTER TABLE `usuario_permiso`
  MODIFY `idusuario_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
